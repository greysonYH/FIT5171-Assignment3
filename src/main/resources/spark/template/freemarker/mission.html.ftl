...
<#else>
    ...
    <ul>
        ...
        <li>Budget: ${mission.budget}</li>
        <li>Duration: ${mission.duration}</li>
    </ul>
</#if>
<#if isCaptain??>
    <li><a href="/mission/${mission.id}/createInv" class="pull-left">Create new Invitations</a></li>
</#if>

    <a href="/missions">Back</a>
</div>
